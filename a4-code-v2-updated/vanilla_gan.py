...
def training_loop(train_dataloader, opts):
    ...
    for epoch in range(opts.num_epochs):
        ...
        for batch in train_dataloader:
            ...
            # D_real_loss = ...
            D_real_loss = torch.nn.functional.mse_loss(D(real_images), torch.ones(n_images))
            ...
            # fake_images = ...
            fake_images = G(noise)[:n_images]

            # 4. Compute the discriminator loss on the fake images
            # D_fake_loss = ...
            D_fake_loss = torch.nn.functional.mse_loss(D(fake_images), torch.zeros(n_images))
            ...
            # G_loss = ...
            G_loss = torch.nn.functional.mse_loss(D(fake_images), torch.ones(n_images))
