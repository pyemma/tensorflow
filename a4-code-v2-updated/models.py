...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        self.deconv1 = deconv(noise_size, conv_dim * 4, 4, stride=2, padding=0)
        self.deconv2 = deconv(conv_dim * 4, conv_dim * 2, 4, stride=2, padding=1)
        self.deconv3 = deconv(conv_dim * 2, conv_dim, 4, stride=2, padding=1)
        self.deconv4 = deconv(conv_dim, 3, 4, stride=2, padding=1, batch_norm=False)
...
class CycleGenerator(nn.Module):
    ...
    def __init__(self, conv_dim=64, init_zero_weights=False):
        ...
        self.deconv1 = deconv(conv_dim * 2, conv_dim, 4, stride=2, padding=1)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv4 = conv(conv_dim * 4, 1, 4, stride=2, padding=0, batch_norm=False)
